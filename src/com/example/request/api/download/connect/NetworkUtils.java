package com.example.request.api.download.connect;
...
public class NetworkUtils {
    ...
    public static String getFileNameFromUrl(String url) {
        ...
        if (filename == null || "".equals(filename.trim())) {// 濡傛灉鑾峰彇涓嶅埌鏂囦欢鍚嶇О
            filename = UUID.randomUUID() + ".apk";// 榛樿鍙栦竴涓枃浠跺悕
        }
        return filename;
    }
}
